    ...
    <section id="our-wedding" className="w-full py-16 md:py-24">
      <div className="container mx-auto px-6 md:px-10 lg:px-14">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-wedding-section-heading text-3xl md:text-4xl tracking-brand uppercase text-wedding-heading mb-12 md:mb-16 text-center">
            Our Wedding
          </h2>
          ...
          <div className="flex justify-center mt-12 md:mt-16">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="elegant" size="sm" className="border-0">
              ...
              <DropdownMenuContent
                align="center"
                className="bg-wedding-main-contrast border border-theme-content-subtle text-charcoal"
              >
