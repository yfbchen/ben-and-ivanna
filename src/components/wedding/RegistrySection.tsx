      ...
      <div className="container mx-auto px-6 md:px-10 lg:px-14">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-wedding-body max-w-2xl mx-auto">
            <p className="font-body text-xs md:text-sm tracking-[0.3em] uppercase text-wedding-heading mb-6">
              Registry
            </p>
            <h2 className="font-display text-3xl md:text-5xl mb-6 text-wedding-heading">
              Gift Registry
            </h2>
